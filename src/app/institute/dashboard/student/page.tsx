...
import {
  ...
  instituteStudentDeleteById,
} from "@/lib/store/institute/student/institute-student-slice";
import {
...
export default function InstituteStudent() {
  ...
  const { instituteStudent } = useAppSelector(
  ...
  // search handle
  let filterData = instituteStudent.filter(
    (student) =>
      student.studentName.toLowerCase().includes(searchedText.toLowerCase()) ||
      student.studentPhoneNumber
        .toLowerCase()
        .includes(searchedText.toLowerCase()) ||
      student.studentEmail.toLowerCase().includes(searchedText.toLowerCase())
  );

  // delete function

  const handleDelete = (id: string) => {
    if (confirm("are your want delete student")) {
      id && dispatch(instituteStudentDeleteById(id));
    }
  };
  ...
  return (
    <>
      <MainContainer title="Student Manage">
        <p>This is Student Manage page </p>
      </MainContainer>
          ...
          <div className="overflow-hidden">
            <table className="min-w-full rounded-xl">
              ...
              <tbody className="divide-y divide-gray-300">
                {filterData.length > 0 ? (
                  filterData.map((student: IStudentData, index) => {
                    return (
                      <tr
                        key={index + 1}
                      ...
                      >
                        ...
                        <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray900">
                          {student.studentName}
                        </td>
                        <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                  ...
                  <tr>
                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                      <p className="text-1xl font-semi font-serif text-red-600 ">
                        No Data Found
                      </p>
                    </td>
                  </tr>
