...
} from "@/lib/store/institute/course/institute-course-slices";
...
export default function InstituteCourse() {
  ...
  return (
    <>
      <MainContainer title="Course Details">
        <p>This is Course Details page </p>
      </MainContainer>
      <div className="flex flex-col mt-5">
        <div className="flex justify-between items-center mb-4">
          ...
          <Link
            href="/institute/dashboard/course/add"
