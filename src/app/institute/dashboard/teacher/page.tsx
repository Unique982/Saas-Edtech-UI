...
export default function InstituteTeacher() {
  ...
  const deleteHandle = (id: string) => {
    if (confirm("Are You Want Delete teacher id")) {
      id && dispatch(deleteInstitiuteTeacherById(id));
    }
  };
          ...
          <div className="overflow-hidden">
            <table className="min-w-full rounded-xl">
              ...
              <tbody className="divide-y divide-gray-300">
                {filterData.length > 0 &&
                  filterData.map(
                    (teacher: IInstituteTeacherInitialDataTeacher, index) => {
                      return (
                        <tr
                          key={index + 1}
                        ...
                        >
                          ...
                          <td className="p-5">
                            <div className="flex items-center gap-1">
                              ...
                              <button
                                onClick={() => deleteHandle(teacher?.id)}
